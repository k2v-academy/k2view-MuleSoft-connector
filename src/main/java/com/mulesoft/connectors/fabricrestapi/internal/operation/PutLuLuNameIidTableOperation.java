...
import com.mulesoft.connectors.fabricrestapi.internal.metadata.PutLuLuNameIidTableInputMetadataResolver;
import com.mulesoft.connectors.fabricrestapi.internal.metadata.PutLuLuNameIidTableOutputMetadataResolver;
...
public class PutLuLuNameIidTableOperation extends BaseRestOperation {
  ...
  public PutLuLuNameIidTableOperation() {}

  /**
   * Update lu by lu name iid table
   *
   * <p>This operation makes an HTTP PUT request to the /lu/{luName}/{iid}/{table} endpoint
   *
   ...
   * @param putLuLuNameIidTableBody the content to use
  ...
  @DisplayName("Update lu by lu name iid table")
  @MediaType("application/json")
  @OutputResolver(output = PutLuLuNameIidTableOutputMetadataResolver.class)
  public void putLuLuNameIidTable(
      ...
      @Content(primary = true)
          @DisplayName("Body")
          @TypeResolver(PutLuLuNameIidTableInputMetadataResolver.class)
          TypedValue<InputStream> putLuLuNameIidTableBody,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
                connection.getBaseUri(), requestPath, HttpConstants.Method.PUT, parameters)
            .setQueryParamFormat(QUERY_PARAM_FORMAT)
            .addHeader("content-type", "application/json")
            .addHeader("accept", "application/json")
            .setBody(putLuLuNameIidTableBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
