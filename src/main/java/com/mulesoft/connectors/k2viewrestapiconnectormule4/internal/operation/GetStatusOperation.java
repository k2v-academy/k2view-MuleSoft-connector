...
import com.mulesoft.connectors.k2viewrestapiconnectormule4.api.metadata.GetStatusOperationStatusFormatQueryParamEnum;
import com.mulesoft.connectors.k2viewrestapiconnectormule4.internal.metadata.GetStatusOutputMetadataResolver;
...
public class GetStatusOperation extends BaseRestOperation {
   ...
   * Get status
   *
   * <p>This operation makes an HTTP GET request to the /status endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param statusFormatQueryParam Status Format
  ...
  @OutputResolver(output = GetStatusOutputMetadataResolver.class)
  public void getStatus(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @Optional @DisplayName("Status Format")
          GetStatusOperationStatusFormatQueryParamEnum statusFormatQueryParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addQueryParam(
                "statusFormat",
                statusFormatQueryParam != null ? statusFormatQueryParam.getValue() : null);
    doRequest(
        config,
        connection,
        builder,
