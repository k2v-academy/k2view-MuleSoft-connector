...
import com.mulesoft.connectors.k2viewrestapiconnectormule4.internal.metadata.GetCommonTableOutputMetadataResolver;
...
public class GetCommonTableOperation extends BaseRestOperation {
  ...
  public GetCommonTableOperation() {}

  /**
   * Get common by table
   *
   * <p>This operation makes an HTTP GET request to the /common/{table} endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param tableUriParam Table name
   * @param whereQueryParam Where string
   * @param fieldsQueryParam Fields names
  ...
  @DisplayName("Get common by table")
  @MediaType("application/json")
  @OutputResolver(output = GetCommonTableOutputMetadataResolver.class)
  public void getCommonTable(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @DisplayName("table") @Summary("Table name") String tableUriParam,
      @Optional @DisplayName("where") @Summary("Where string") String whereQueryParam,
      @Optional @DisplayName("fields") @Summary("Fields names") String fieldsQueryParam,
