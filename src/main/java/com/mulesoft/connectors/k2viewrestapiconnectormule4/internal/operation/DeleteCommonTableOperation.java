...
import com.mulesoft.connectors.k2viewrestapiconnectormule4.internal.metadata.DeleteCommonTableOutputMetadataResolver;
...
public class DeleteCommonTableOperation extends BaseRestOperation {
  ...
  public DeleteCommonTableOperation() {}

  /**
   * Delete common by table
   *
   * <p>This operation makes an HTTP DELETE request to the /common/{table} endpoint
   *
  ...
  @DisplayName("Delete common by table")
  @MediaType("application/json")
  @OutputResolver(output = DeleteCommonTableOutputMetadataResolver.class)
  public void deleteCommonTable(
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addQueryParam("set", setQueryParam != null ? setQueryParam : null);
    doRequest(
        config,
        connection,
        builder,
