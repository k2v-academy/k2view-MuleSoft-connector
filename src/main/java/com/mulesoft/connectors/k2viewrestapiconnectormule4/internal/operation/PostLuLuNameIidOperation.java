...
import com.mulesoft.connectors.k2viewrestapiconnectormule4.internal.metadata.PostLuLuNameIidInputMetadataResolver;
import com.mulesoft.connectors.k2viewrestapiconnectormule4.internal.metadata.PostLuLuNameIidOutputMetadataResolver;
...
public class PostLuLuNameIidOperation extends BaseRestOperation {
  private static final String OPERATION_PATH = "/lu/{luName}/{iid}";

  private static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT =
      RestRequestBuilder.QueryParamFormat.MULTIMAP;

  public PostLuLuNameIidOperation() {}

  /**
   * Create lu by lu name iid
   *
   * <p>This operation makes an HTTP POST request to the /lu/{luName}/{iid} endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param luNameUriParam LU name
   * @param iidUriParam iid to read
   * @param postLuLuNameIidBody the content to use
  ...
  @DisplayName("Create lu by lu name iid")
  @MediaType("application/json")
  @OutputResolver(output = PostLuLuNameIidOutputMetadataResolver.class)
  public void postLuLuNameIid(
      ...
      @Content(primary = true)
          @DisplayName("Body")
          @TypeResolver(PostLuLuNameIidInputMetadataResolver.class)
          TypedValue<InputStream> postLuLuNameIidBody,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postLuLuNameIidBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
